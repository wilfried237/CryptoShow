...
<div id="dialog2" class="dialog">
        <div class="dialog-content rounded">
            ...
            <div class="p-5">
                <form id="formEvent2" method="POST">
                    <div class="mb-3">
                        <label for="NameInput" class="form-label">Name</label>
                        <input type="text" name="name" class="form-control" id="NameInput2" placeholder="Event Name">
                    </div>
                    <div class="mb-3">
                        <label for="DateInput" class="form-label">Date</label>
                        <input type="date" name="date" class="form-control" id="DateInput2">
                    </div>
                    <div class="mb-3">
                        <label for="LocationInput" class="form-label">Location</label>
                        <input type="text" name="location" class="form-control" id="LocationInput2" placeholder="Location">
                    </div>
                    <div class="mb-3">
                        <label for="ImageInput" class="form-label">ImageURl</label>
                        <input type="text" name="image" class="form-control" id="ImageInput2" placeholder="Image Link">
                    </div>
                    <div class="mb-3">
                        <label for="LimitInput" class="form-label">Limit Participants</label>
                        <input type="number" name="limit" class="form-control" id="LimitInput2" placeholder="Limit people">
                    </div>
                    <div class="mb-3">
                        <label for="DescriptionTextarea" class="form-label">Description</label>
                        <textarea name="description" class="form-control" id="DescriptionTextarea2" rows="3"></textarea>
                    </div>
                    <div class="d-flex justify-content-end">
